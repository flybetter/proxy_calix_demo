            ...
            if(response.toString().contains("success")){
                ...
                if (response != null) {
                    ...
                    if (startIndex != -1 && endIndex != -1) {
                        request.append("<param name=\"oid\"><value>{"
...
//        runnable.run();
        ...
        TemplateSender templateSender=new TemplateSender();
        templateSender.send("127.0.0.1",9002,1000*1000,"rootgod","root",1);
